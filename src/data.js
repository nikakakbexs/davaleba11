const galleryData = [
  {
    ...
    images: {
      thumbnail: "./assets/starry-night/gallery.jpg",
      hero: {
  ...
  },
  {
    ...
    images: {
      thumbnail: "./assets/penitent-magdalene/gallery.jpg",
      hero: {
  ...
  },
  {
    ...
    images: {
      thumbnail: "./assets/the-storm-on-the-sea-of-galilee/gallery.jpg",
      hero: {
  ...
  },
  {
    ...
    images: {
      thumbnail: "./assets/lady-with-an-ermine/gallery.jpg",
      hero: {
  ...
  },
  {
    ...
    images: {
      thumbnail: "./assets/the-boy-in-the-red-vest/hero-small.jpg",
      hero: {
  ...
  },
  {
    ...
    images: {
      thumbnail: "./assets/arnolfini-portrait/hero-large.jpg",
      hero: {
  ...
  },
  {
    ...
    images: {
      thumbnail: "./assets/the-swing/gallery.jpg",
      hero: {
